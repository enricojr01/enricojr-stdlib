...
public class LinkedList<T> implements 
    ...
    /**
     * This class attempts to implement a textbook Linked List data structure. Maintains a 
     * reference to a head and tail of type LinkedListNode<T>, and can be used as a Sequence and 
     * Dynamic Array.
     * 
    ...
    public int hashCode() {
        ...
        // NOTE: Copied from the Java List.hashCode() documention. I don't know enough math to
        // know better.
        // TODO: Know better
        for (T item : this) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        // TODO: is there no way around the unsafe cast? this equals() was generated by vs code
        ...
        int ptr = 0;
        while (ptr != this.len()) {
            T item1 = this.getAt(ptr);
            T item2 = other.getAt(ptr);
